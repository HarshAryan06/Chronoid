...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen w-full bg-white dark:bg-[#0a0a0a] font-sans transition-colors duration-0">
      ...
      {/* Mobile Header - Fixed positioning to float over content (removes white bar artifact) */}
      <div className="md:hidden fixed top-4 left-4 right-4 h-16 px-6 flex justify-between items-center z-50 rounded-full bg-white/70 dark:bg-black/60 backdrop-blur-xl border border-stone-200/50 dark:border-white/10 shadow-sm transition-all duration-300">
      ...
      <div className="flex flex-col md:flex-row flex-1 w-full">
        ...
        */}
        ...
        {/* Preview Area (Hero)
            ...
            - Added pt-24 on mobile to accommodate fixed header
        */}
        <div className="order-1 md:order-2 flex-1 relative flex flex-col min-h-0 bg-sand dark:bg-[#0a0a0a] pt-24 md:pt-0">
