...
import { Github, Moon, Sun, Star } from 'lucide-react';
...
export const HeaderActions: React.FC<HeaderActionsProps> = ({ isDarkMode, toggleTheme }) => (
  <div className="flex items-center gap-3">
    <a
      ...
      className="h-10 px-4 flex items-center gap-2 rounded-full bg-stone-800 dark:bg-white text-white dark:text-stone-900 hover:bg-stone-700 dark:hover:bg-stone-100 transition-all text-sm font-semibold shadow-sm"
